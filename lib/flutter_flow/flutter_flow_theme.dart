...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent5 = const Color(0xFFFFD4AF);
  late Color accent6 = const Color(0xFFFFC0CF);
  late Color accent1B = const Color(0xFFB555CB);
  late Color accent2B = const Color(0xFF64BDCF);
  late Color accent3B = const Color(0xFF58B878);
  late Color accent4B = const Color(0xFFCFC33B);
  late Color accent5B = const Color(0xFFC9874F);
  late Color accent6B = const Color(0xFFCA5C77);
  late Color buttonShadow = const Color(0xFF163959);
  late Color customColor1 = const Color(0xFF3E1674);
